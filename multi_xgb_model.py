...
class MultiXGBModel:
    def __init__(self, input_size, output_size, learning_rate, max_depth=5, num_boost_round=1, force_no_parallel=True, **kwargs):
        """
        model: (XGBoost)
        """
        ...
        for i in range(self.output_size):
            single_model = OnlineXGB(max_depth=max_depth, n_jobs=-1, learning_rate=learning_rate, **kwargs)
